...
namespace Analyzer1 
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(MethodAnalyzer)), Shared]
    class MethodCodeFix: CodeFixProvider
    {
        private const string title = "Method naming";
